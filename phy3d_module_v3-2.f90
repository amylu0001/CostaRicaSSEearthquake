...
real (DP0), DIMENSION(:,:), ALLOCATABLE :: stiff
character(len=80) :: jobname,foldername,restartname,sstiffname,profile
!ALu !ED
character(len=80) :: nstiffname, fricname, patchname !folder
real (DP0), DIMENSION(:,:), ALLOCATABLE :: nstiff
